...
def run_test_make_simple_list():
    ...
    expected = [3, 4, 5]
    actual = make_simple_list(3, 5)
    print('Expected:', expected)
    print('Actual:  ', actual)

    expected = [2, 3, 4, 5, 6, 7, 8, 9]
    actual = make_simple_list(2, 9)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    print('--------------------------------------------------')
    expected = '2-3-4-5-6-7-8-9'
    actual = make_less_simple_string(2, 9)
    print('Expected:', expected)
    print('Actual:  ', actual)
    expected = '3-4-5'
    actual = make_less_simple_string(3, 5)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        rectangles = rectangles + [rg.Rectangle(rg.Point(circles[k].center.x-circles[k].radius, circles[k].center.y-circles[k].radius), rg.Point(circles[k].center.x+circles[k].radius, circles[k].center.y+circles[k].radius))]
    return rectangles
